...
final kMeals = <Meal>[
  Meal(
    ...
    imageUrl:
        'https://upload.wikimedia.org/wikipedia/commons/thumb/2/20/Spaghetti_Bolognese_mit_Parmesan_oder_Grana_Padano.jpg/80px-Spaghetti_Bolognese_mit_Parmesan_oder_Grana_Padano.jpg',
    duration: 20,
    ingredients: [
      '4 Tomates',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/214/10/23/18/5/burger-50054_1280.jpg',
    duration: 45,
    ingredients: [
      '30g Gado Hack',
      '1 tomate',
  ...
  Meal(
    ...
    imageUrl:
        'https://cdn.pixabay.com/photo/218/3/31/19/29/schnitzel-327945_1280.jpg',
    duration: 60,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/216/10/25/13/29/smoked-salmon-salad-1768890_1280.jpg',
    duration: 15,
    ingredients: [
      'Rúcula',
      'Alface-de-cordeiro',
  ...
  Meal(
    ...
    imageUrl:
        'https://cdn.pixabay.com/photo/217/5/1/5/18/pastry-2274750_1280.jpg',
    duration: 240,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/218/7/10/21/23/pancake-3529653_1280.jpg',
    duration: 20,
    ingredients: [
  ...
  Meal(
    ...
    complexity: Complexity.medium,
    imageUrl:
        'https://cdn.pixabay.com/photo/218/6/18/16/5/indian-food-3482749_1280.jpg',
    duration: 35,
    ingredients: [
      '4 Peitos de Frango',
      '1 cebola',
  ...
  Meal(
    ...
    complexity: Complexity.simple,
    imageUrl:
        'https://cdn.pixabay.com/photo/218/4/9/18/26/asparagus-334997_1280.jpg',
    duration: 30,
    ingredients: [
